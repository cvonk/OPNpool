/**
 * @brief OPNpool, hass_task: listen for commands over MQTT, and support MQTT discovery
 *
...
static dispatch_t _dispatches[] = {
    ...
    { { HASS_DEV_TYP_sensor,  "pump_status",  "pump status",  NULL  }, { _sensor_init, _sensor_state,  NULL }, { POOLSTATE_ELEM_TYP_PUMP,   POOLSTATE_ELEM_PUMP_TYP_STATE, 0 } },
    { { HASS_DEV_TYP_sensor,  "pump_power",   "pump power",   "W"   }, { _sensor_init, _sensor_state,  NULL }, { POOLSTATE_ELEM_TYP_PUMP,   POOLSTATE_ELEM_PUMP_TYP_PWR, 0 } },
